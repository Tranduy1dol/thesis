...
| EUF-CMA | Existential Unforgeability under Chosen Message Attack — Tính không thể giả mạo dưới tấn công thông điệp chọn trước |
| FFT | Fast Fourier Transform — Biến đổi Fourier nhanh |
| FIPS | Federal Information Processing Standards — Tiêu chuẩn xử lý thông tin liên bang (Hoa Kỳ) |
| FRI | Fast Reed-Solomon Interactive Oracle Proof — Chứng minh oracle tương tác Reed-Solomon nhanh |
| KSS | Kachisa-Schaefer-Scott — Họ đường cong elliptic pairing-friendly |
...
| PLONK | Permutations over Lagrange-bases for Oecumenical Noninteractive arguments of Knowledge — Hệ chứng minh ZK không tương tác |
