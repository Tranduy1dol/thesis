...
\item
  ...
  field primes by constraining the cyclotomic seed \(T\). Choosing
  \(T \equiv 0 \pmod{2^{12}}\) yields \(\nu_2(r-1) \geq 36\)
  deterministically, while an extended lift search ensures
  \(\nu_2(p-1) \geq 36\). The resulting two-adicity of 36 exceeds
  BLS12-381's value of 32.
\item
...
\item
  ...
  point---is published and validated by a Rust implementation with 36
  passing tests.
\end{enumerate}
