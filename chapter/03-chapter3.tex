...
\addcontentsline{toc}{chapter}{Phương pháp xây dựng đường cong elliptic}
\chapter[]{Phương pháp xây dựng đường cong elliptic}
...
\section{Phương pháp Nhân phức (Complex Multiplication
Method)}\label{phux1b0ux1a1ng-phuxe1p-nhuxe2n-phux1ee9c-complex-multiplication-method}

\subsection{Ý tưởng cốt lõi}\label{uxfd-tux1b0ux1edfng-cux1ed1t-luxf5i}
...
\CommentTok{// Đảm bảo r thỏa mãn: two\_adicity(r{-}1) = 3 * v₂(T) \textgreater{}= s}
\end{Highlighting}
\end{Shaded}
