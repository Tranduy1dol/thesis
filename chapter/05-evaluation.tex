...
\begin{table}[t]
\centering
\caption{Performance benchmarks (Criterion, release build, LLVM O3, projective
coordinates with Montgomery ladder)}
\begin{tabular}{llll}
\toprule
...
Fig.\textasciitilde{}\ref{fig:comparison} visualizes this tradeoff.
